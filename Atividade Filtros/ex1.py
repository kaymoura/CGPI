...
filtro_media_3x3 = cv2.blur(imagem, (3, 3))
filtro_media_15x15 = cv2.blur(imagem, (6, 6))

#Aplicando Filtro Mediana (Suaviza)
filtro_gaussiano_mediana_7 = cv2.GaussianBlur(imagem, (5,5),0)
filtro_gaussiano_mediana_15 = cv2.GaussianBlur(imagem, (11,11),0)
