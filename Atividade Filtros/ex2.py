...
filtro_media_3x3 = cv2.blur(imagem, (4, 4))
filtro_media_15x15 = cv2.blur(imagem, (2, 2))

#Aplicando Filtro Mediana (Suaviza)
filtro_gaussiano_mediana_7 = cv2.GaussianBlur(imagem, (9,9),0)
filtro_gaussiano_mediana_15 = cv2.GaussianBlur(imagem, (17,17),0)
...
plt.imshow(filtro_media_3x3, cmap='gray')
plt.axis('off')
